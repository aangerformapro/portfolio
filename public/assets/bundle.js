...
var Config = /*#__PURE__*/function () {
  ...
  _createClass(Config, [{
    ...
    value: function _mergeConfigObj(config, element) {
      ...
      return _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, this.constructor.Default), _typeof(jsonConfig) === 'object' ? jsonConfig : {}), isElement$1(element) ? Manipulator.getDataAttributes(element) : {}), _typeof(config) === 'object' ? config : {});
    }
  }, {
...
var BackedEnum = /*#__PURE__*/function () {
  function BackedEnum(value) {
    _classCallCheck(this, BackedEnum);
  ...
  _createClass(BackedEnum, [{
    ...
    value: function from(value) {
      return this.cases().find(function (x) {
    ...
    value: function cases() {
      ...
      return Object.keys(this).filter(function (name) {
        return name === name.toUpperCase() && _this[name] instanceof BackedEnum;
      }).map(function (x) {
        return _this[x];
      });
    }
...
var ICON_PSR = "<svg version=\"1.0\" xmlns=\"http://www.w3.org/2000/svg\" width=\"28px\" height=\"28px\" viewBox=\"0 0 32.000000 32.000000\" preserveAspectRatio=\"xMidYMid meet\"><g transform=\"translate(0.000000,32.000000) scale(0.100000,-0.100000)\" fill=\"currentColor\" stroke=\"none\"><path d=\"M130 310 c-8 -5 -27 -11 -42 -15 -16 -3 -28 -12 -28 -20 0 -8 -12 -22 -26 -31 -19 -13 -24 -23 -20 -40 4 -13 1 -34 -6 -48 -9 -21 -8 -29 4 -43 9 -10 18 -27 20 -38 2 -11 13 -25 26 -31 12 -6 30 -17 39 -26 23 -19 104 -18 128 2 9 8 27 19 38 25 12 6 23 19 25 30 2 11 11 28 20 38 12 14 13 22 4 43 -7 14 -10 35 -6 48 4 17 -1 27 -20 40 -14 9 -26 23 -26 31 0 8 -12 17 -27 20 -16 4 -36 10 -45 16 -21 11 -38 11 -58 -1z m65 -170 l-60 -60 -34 34 c-30 30 -33 37 -21 51 12 14 15 14 35 -5 l21 -20 44 45 c39 40 46 43 59 30 14 -13 9 -22 -44 -75z\" /></g></svg>",
  ICON_TWIG = "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 32 32\" width=\"32\" height=\"32\"><path d=\"M4.574,5.463c.262.4,2.5-1.608,4.454-1.161,2.061.472,4.014,3.724,4.848,13.7a40.18,40.18,0,0,1,3.541,3.61q.53.614,1.013,1.22a11.847,11.847,0,0,1,.229-1.4,12.3,12.3,0,0,1,1.981-4.4A19.151,19.151,0,0,0,17.272,7.9c-1.03-1.445-4.6-6.478-8.546-5.843C6.182,2.465,4.3,5.054,4.574,5.463Z\" fill=\"#63bf6a\"><path d=\"M24.4,30c-.32-2.567-.448-4.76-.5-6.449-.094-3.232.1-4.541.9-5.756.193-.295,1.288-1.975,2.58-1.863,1.466.128,2.213,2.414,2.362,2.337.175-.09-.36-3.543-2.532-4.431-2.6-1.063-6.312,2.07-7.8,5.154a12.223,12.223,0,0,0-.857,2.81,32.555,32.555,0,0,0-.71,8.2Z\" fill=\"#74d74d\"><path d=\"M2.238,13.935c.145-.447,2.468-.259,4.54.293,2.5.666,7,2.344,11.651,8.606A12.544,12.544,0,0,1,20.279,30H10.386a21.875,21.875,0,0,0-.175-4.62,14.9,14.9,0,0,0-2.459-7.158C5.441,15.159,2.055,14.5,2.238,13.935Z\" fill=\"#78dc50\"><path d=\"M17.3,21.323a1.753,1.753,0,1,1-.513-1.24A1.748,1.748,0,0,1,17.3,21.323Z\" fill=\"#fff\"><path d=\"M21.975,21.323a1.753,1.753,0,1,1-.513-1.24A1.748,1.748,0,0,1,21.975,21.323Z\" fill=\"#fff\"></svg>",
  ICON_NETBEANS = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"28\" height=\"32\" viewBox=\"0 0 444 512\" version=\"1.1\" width=\"32\" height=\"32\"><g id=\"logo\" stroke-width=\"0\" fill=\"none\" fill-rule=\"evenodd\"><path d=\"M222,0 L222,99 L86,178 L0,128 L222,0 Z\" fill=\"#A1C535\"/><path d=\"M444,128 L358,178 L222,99 L222,0 L444,128 L444,128 Z\" fill=\"#ADD439\"/><path d=\"M444,384 L358,334 L358,178 L444,128 L444,384 L444,384 Z\" fill=\"#1B6AC6\"/><path d=\"M222,512 L222,413 L358,334 L444,384 L222,512 L222,512 Z\" fill=\"#2E90E8\"/><path d=\"M0,384 L86,334 L222,413 L222,512 L0,384 L0,384 Z\" fill=\"#EA205E\"/><path d=\"M0,128 L86,178 L86,334 L0,384 L0,128 L0,128 Z\" fill=\"#A5073E\"/><path d=\"M86,178 L222,99 L358,178 L222,256 L86,178 Z\" fill=\"#F1F6E2\"/><path d=\"M222,256 L358,178 L358,334 L222,413 L222,256 Z\" fill=\"#CEDBE6\"/><path d=\"M86,178 L222,256 L222,413 L86,334 L86,178 Z\" fill=\"#FFFFFF\"/></g></svg>";

var Tag = /*#__PURE__*/function (_BackedEnum) {
  _inherits(Tag, _BackedEnum);
...
_defineProperty(Tag, "HTML", new Tag('html'));
_defineProperty(Tag, "CSS", new Tag('css'));
_defineProperty(Tag, "JS", new Tag('js'));
_defineProperty(Tag, "PHP", new Tag('php'));
_defineProperty(Tag, "IDE", new Tag('ide'));
var Skills = /*#__PURE__*/function () {
  function Skills(tags, skills) {
    var _this = this;
    ...
    var tagRoot = this.elements.tags.root = createElement$1('<div class="icons d-flex"/>', tags.map(function (item) {
      var _item = _slicedToArray(item, 3),
        tag = _item[0],
        label = _item[1],
        icon = _item[2];
      _this.elements.tags.targets.push(createElement$1('div', {
        class: 'skill-lang',
        data: {
          toggle: 'tag',
          tag: tag.value,
      ...
      return _this.elements.tags.targets[_this.elements.tags.targets.length - 1];
    }));
    this.elements.list.root = createElement$1('<div class="card-body list-skills"/>', createElement$1('<div class="d-flex flex-wrap justify-content-between"/>', skills.map(function (item) {
      var label = item.label,
        describe = item.describe,
        icon = item.icon;
      _this.elements.list.targets.push(createElement$1('<div class="d-flex align-items-center px-3 py-2 col-6 col-lg-3 mb-3" data-bs-toggle="tooltip"/>', {
        title: label,
        data: {
      ...
      }, [createElement$1('<div class="icon fs-2 d-flex"/>', icon), createElement$1('<div class="describe"/>', describe)]));
      return _this.elements.list.targets[_this.elements.list.targets.length - 1];
    })));
    tagRoot.addEventListener('click', function (e) {
      var t = e.target.closest('[data-toggle="tag"]');
      if (t) {
        var tag = Tag.from(dataset(t, 'tag'));
        if (tag) {
          _this.filter(tag);
        }
      }
...
var TAG_ICONS = [[Tag.HTML, 'HTML 5', '<i class="devicon-html5-plain-wordmark colored"></i>'], [Tag.CSS, 'CSS 3', '<i class="devicon-css3-plain-wordmark colored"></i>'], [Tag.JS, 'JavaScript ESNext', '<i class="devicon-javascript-plain colored"></i>'], [Tag.PHP, 'PHP [ 7.4 - 8.2 ]', '<i class="devicon-php-plain colored"></i>'], [Tag.IDE, 'Environnement de Développement', '<i class="bi bi-code-slash"></i>']];
var SKILLS = [{
...
var ProjectLink = /*#__PURE__*/_createClass(function ProjectLink(src, label, icon) {
  ...
  this.label = _ref[1];
  this.icon = _ref[2];
  this.element = createElement$1('<a target="_blank" class="link-secondary d-flex justify-content-center align-items-center"/>', {
    href: src,
    data: {
      bs: {
        toggle: 'tooltip',
  ...
  }, [isHTML(icon) ? icon : createElement$1('i', {
    class: icon
  })]);
});
...
var Project = /*#__PURE__*/_createClass(function Project(data) {
  ...
  })), body = createElement$1('<div class="card-body pb-0 d-flex flex-column text-center">', [title = createElement$1('<div class="card-title fw-bold fs-3 mt-0"/>', data.label), text = createElement$1('<div class="card-text"/>', data.describe)]), footer = createElement$1('<div class="card-footer fs-3 d-flex justify-content-end align-items-center"/>', data.links.map(function (item) {
...
_defineProperty(Direction, "Top", new Direction("top"));
_defineProperty(Direction, "Bottom", new Direction("bottom"));
_defineProperty(Direction, "Left", new Direction("left"));
_defineProperty(Direction, "Right", new Direction("right"));
var _currentTarget = /*#__PURE__*/new WeakMap();
...
var ScrollSnap = /*#__PURE__*/function () {
  ...
  function ScrollSnap(targets) {
    ...
    if (targets.length > 0) {
      _classPrivateFieldSet(this, _observer, new IntersectionObserver(function (entries) {
        for (var i = 0; i < entries.length; i++) {
          ...
          if (item.isIntersecting) {
            scrollIntoView(_classPrivateFieldSet(_this2, _currentTarget, item.target)).then(function (view) {
  ...
  _createClass(ScrollSnap, [{
    key: "currentTarget",
    get: function get() {
      return _classPrivateFieldGet(this, _currentTarget);
    }
  }, {
    key: "observer",
    get: function get() {
      return _classPrivateFieldGet(this, _observer);
    }
  }, {
    key: "started",
    get: function get() {
    ...
    key: "targets",
    get: function get() {
      return _classPrivateFieldGet(this, _targets);
    }
  }, {
    key: "start",
    value: function start() {
      ...
      if (!_classPrivateFieldGet(this, _started)) {
        _classPrivateFieldGet(this, _targets).forEach(function (elem) {
          return _classPrivateFieldGet(_this3, _observer).observe(elem);
        });
...
var _findview = /*#__PURE__*/new WeakSet();
var NavPills = /*#__PURE__*/function () {
  function NavPills(views, root) {
    var _this = this;
    _classCallCheck(this, NavPills);
    _classPrivateMethodInitSpec(this, _findview);
    ...
    _defineProperty(this, "element", void 0);
    _defineProperty(this, "pills", void 0);
    if (views instanceof ScrollSnap === false) {
      throw new TypeError('argument views not an instance of ScrollSnap');
    }
    EventManager.mixin(this);
    _classPrivateFieldSet(this, _views, views);
    if (!isElement(root)) {
      root = document.body;
    }
    _classPrivateFieldSet(this, _root, root);
    var targets = views.targets,
      pills = this.pills = {};
    var elem = this.element = createElement$1('<div class="nav-pills">', targets.filter(function (t) {
      return t.matches('[id][title]');
    }).map(function (target) {
      var id = target.id,
    ...
    views.on('change', function (e) {
      _this.trigger('change', {
        view: e.data.view,
        pill: pills[e.data.view.id]
      });
    });
    root.appendChild(elem);
    elem.addEventListener('click', function (e) {
      var pill = e.target.closest('[href^="#"]');
      if (pill) {
        e.preventDefault();
        if (!pill.classList.contains('active')) {
          _this.scrollTo(pill.dataset.id);
        }
      }
    });
  }
  _createClass(NavPills, [{
    key: "views",
    get: function get() {
      return _classPrivateFieldGet(this, _views);
    }
  }, {
    key: "targets",
    get: function get() {
      return _classPrivateFieldGet(this, _views).targets;
    }
  }, {
    key: "scrollTo",
    value: function scrollTo() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var view = _classPrivateMethodGet(_this2, _findview, _findview2).call(_this2, id),
          pill = _this2.pills[id];
        if (view && pill) {
          _this2.one('change', function (e) {
            resolve(view);
          });
          _this2.trigger('change', {
            view: view,
...
// scroll behaviour
(function () {
  var navlinks = _toConsumableArray(document.querySelectorAll('header [href*="#"]'));
  var views = new ScrollSnap('#home, .page'),
    pills = new NavPills(views);
  pills.on('change', function (e) {
    var _e$data = e.data,
      view = _e$data.view,
      pill = _e$data.pill;
...
(function () {
  ...
  document.querySelectorAll('form.needs-validation input:not([type="submit"]), form.needs-validation textarea').forEach(function (form) {
    return form.addEventListener('keyup', checkForm);
  });
})();
...
(function () {
  var card = document.querySelector('#skills .card'),
...
// tooltips
(function () {
  _toConsumableArray(document.querySelectorAll('[data-bs-toggle="tooltip"]')).filter(function (elem) {
    return elem.matches('[title],[data-bs-title]');
  }).map(function (elem) {
...
(function () {
  var date = new Date(),
    age = parseInt(Math.floor(date - new Date('12/15/1982, 21:07')) / (1000 * 60 * 60 * 24 * 365));
  document.querySelectorAll('.age').forEach(function (elem) {
    return elem.innerHTML = "".concat(age, " ans");
  });
  document.querySelectorAll('.year').forEach(function (elem) {
    return elem.innerHTML = date.getFullYear();
  });
})();
